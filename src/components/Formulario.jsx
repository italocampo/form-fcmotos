...
export default function Formulario() {
  ...
  const questions = [
    { type: "text", field: "nome", label: "1. Nome completo:" },
    {
      type: "text",
      field: "whatsapp",
      label: "2. WhatsApp com DDD para contato:",
      placeholder: "(XX) 9XXXX-XXXX",
    },
    {
      type: "text",
      field: "cidade_bairro",
      label: "3. Estado e cidade onde mora atualmente:",
    },
    { type: "text", field: "idade", label: "4. Idade:" },
    {
      type: "text",
      field: "instagram",
      label: "5. Qual o seu Instagram pessoal (caso tenha)?",
    },
    {
      type: "radio",
    ...
    },
    {
      ...
      label:
        "8. Para se tornar sócio e abrir uma nova unidade da FC Motos, o investimento inicial é a partir de R$ 350 mil. Qual faixa de valor você tem disponível hoje para investir?",
      options: [
        "A partir de R$ 295 mil",
    ...
    },
    {
      ...
      label:
        "9. Você já teve algum tipo de experiência com gestão, vendas ou administração?",
      options: ["Sim", "Não"],
      hasSubQuestion: true,
    ...
    },
    {
      ...
      label:
        "10. Está disposto a seguir processos, metas e alinhamentos mensais?",
      options: ["Sim", "Não"],
    },
  ];
  ...
  const handleNext = (valorManual) => {
    const valorParaChecar =
      typeof valorManual === "string" ? valorManual : formData[currentQ.field];

    if (
      !valorParaChecar &&
      currentQ.field !== "instagram" &&
      currentQ.field !== "whatsapp"
    ) {
